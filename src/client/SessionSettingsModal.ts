...
type ActiveTab = 'model' | 'mcp' | 'skills'
...
export function SessionSettingsModal({
  ...
  const [activeTab, setActiveTab] = React.useState<ActiveTab>('model')
  ...
  const [cloneOpen, setCloneOpen] = React.useState<boolean>(false)
  const [selectedSourceSessionId, setSelectedSourceSessionId] =
    React.useState<string>('')
  const [manualSourceSessionId, setManualSourceSessionId] =
    React.useState<string>('')
  ...
  const handleClonePreset = async () => {
    const targetSourceId = (
      manualSourceSessionId.trim() || selectedSourceSessionId
    ).trim()
    if (!targetSourceId) {
  ...
  return e(
    ...
    e(
      ...
      e(
        ...
        e(
          'div',
          { className: 'dsh-sam-header-right' },
          // Clone Preset Button
          sessionId
            ? e(
                'button',
      ...
      e('p', { className: 'dsh-sam-desc' }, t('sessionSettings.desc')),
    ),
    ...
    cloneOpen
      ? e(
          'div',
          { className: 'dsh-clone-panel' },
          e(
            'div',
            { className: 'dsh-clone-panel-header' },
            e(
              'div',
              { className: 'dsh-clone-title-row' },
              e(IconBranchOutline16, { size: 15 }),
              e(
                'span',
                { className: 'dsh-clone-title' },
                t('sessionSettings.clone.title'),
              ),
            ),
            e(
              'button',
              ...
              t('sessionSettings.clone.cancel'),
            ),
          ),
          e(
            'p',
            { className: 'dsh-clone-desc' },
            t('sessionSettings.clone.desc'),
          ),
          ...
          e(
            ...
            otherSessionList.length > 0
              ? e(
                  ...
                  e(
                    ...
                    t('sessionSettings.clone.selectLabel'),
                  ),
                  e(
                    'select',
                    {
                    ...
                    e(
                      'option',
                      { value: '' },
                      t('sessionSettings.clone.selectPlaceholder'),
                    ),
                    otherSessionList.map((s) =>
                      e(
                        'option',
                        { key: s.id, value: s.id },
                        `${s.title} (${s.id})`,
            ...
            e(
              ...
              e(
                'label',
                { className: 'dsh-sam-field-label' },
                t('sessionSettings.clone.manualLabel'),
              ),
              e('input', {
                type: 'text',
                className: 'dsh-sam-select',
    ...
    e(
      ...
      e(
        ...
        e(
          ...
          sessionId
            ...
            : t('sessionSettings.scope.globalDefault'),
        ),
        sessionId
          ? e(
              'span',
      ...
      e(
        'div',
        { className: 'dsh-sam-status-detail' },
        `模型: ${
    ...
    e(
      ...
      e(
        ...
        e(IconSkillOutline16, { size: 14, className: 'dsh-tab-icon' }),
        t('sessionSettings.tab.skills'),
        availableSkills.length > 0
          ? e(
              'span',
              { className: 'dsh-tab-badge' },
                ...
                e(
                  ...
                  e(
                    ...
                    e('input', {
                      ...
                      value: skillsSearch,
                      onChange: (evt: any) => setSkillsSearch(evt.target.value),
                    }),
                  ),
                  e(
                    'div',
    ...
    e(
      'div',
      { className: 'dsh-sam-actions dsh-session-actions' },
