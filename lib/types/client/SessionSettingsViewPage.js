...
import { IconCloseOutline16, IconCodeOutline16, IconLinkOutline16, IconCheckOutline16, IconCopyOutline16, IconBranchOutline16, IconLoadingOutline16, IconAgentPresetOutline16, IconRefreshOutline16, IconSearchOutline16, IconChecklistOutline14, IconSkillOutline16, } from '@deepseek-ai/dsh-client-ui-primitives';
...
export function SessionSettingsViewPage({ api, t, sessionId, sessionTitle: _sessionTitle, useSessions, onSave, }) {
    ...
    e('div', { className: 'dsh-session-view-header' }, e('div', { className: 'dsh-session-view-header-left' }, e('h2', { className: 'dsh-session-view-title' }, t('sessionSettings.title')), sessionId
        ? e('button', {
            type: 'button',
            ...
            : e(IconCopyOutline16, { size: 13 }), e('span', null, copiedId ? t('sessionSettings.idCopied') : sessionId))
        : null, sessionId
        ? e('span', {
    ...
    sessionId
        ? e('div', { className: 'dsh-clone-toolbar' }, e('span', { className: 'dsh-clone-label' }, t('sessionSettings.clone.toolbarTitle')), e('input', {
            type: 'text',
    ...
    // Notifications
    saveSuccessMsg
        ? e('div', { className: 'dsh-sam-notice success dsh-view-notice' }, saveSuccessMsg)
        : null, error || cloneError
        ? e('div', { className: 'dsh-sam-notice error dsh-view-notice' }, error || cloneError)
        : null, 
    // Main Split Body: Sub-sidebar + Content
    e('div', { className: 'dsh-session-view-body' }, 
    // Left Sub-sidebar (Clean: Icon + Title + Badge, no subtitle description)
    e('div', { className: 'dsh-session-view-sidebar' }, e('button', {
        type: 'button',
        className: `dsh-view-sidebar-item ${activeNav === 'model' ? 'active' : ''}`,
        onClick: () => setActiveNav('model'),
    }, e('div', { className: 'dsh-view-item-icon' }, e(IconAgentPresetOutline16, { size: 16 })), e('span', { className: 'dsh-view-item-title' }, t('sessionSettings.nav.modelTitle')), e('span', { className: 'dsh-view-item-badge' }, modelConfig.mode === 'custom' && modelConfig.model
        ? modelConfig.model
        : modelConfig.mode === 'inherit'
            ? t('sessionSettings.status.inherit')
            : t('sessionSettings.status.default'))), e('button', {
        type: 'button',
        className: `dsh-view-sidebar-item ${activeNav === 'mcp' ? 'active' : ''}`,
        onClick: () => setActiveNav('mcp'),
    }, e('div', { className: 'dsh-view-item-icon' }, e(IconCodeOutline16, { size: 16 })), e('span', { className: 'dsh-view-item-title' }, t('sessionSettings.nav.mcpTitle')), e('span', {
        className: `dsh-view-item-badge ${effectiveActiveMcpCount > 0 ? 'highlight' : ''}`,
    }, effectiveActiveMcpCount > 0
        ? `${effectiveActiveMcpCount} MCP`
        : t('sessionSettings.status.none'))), e('button', {
        type: 'button',
        className: `dsh-view-sidebar-item ${activeNav === 'skills' ? 'active' : ''}`,
        onClick: () => setActiveNav('skills'),
    }, e('div', { className: 'dsh-view-item-icon' }, e(IconSkillOutline16, { size: 16 })), e('span', { className: 'dsh-view-item-title' }, t('sessionSettings.nav.skillsTitle')), e('span', {
    ...
    e('div', { className: 'dsh-session-view-content' }, 
    // Tab 1: Subagent Model
    activeNav === 'model'
        ? e('div', { className: 'dsh-view-content-inner' }, 
        // Section Header: Title + Description
        e('div', { className: 'dsh-section-header' }, e('h3', { className: 'dsh-section-title' }, t('sessionSettings.section.modelTitle')), e('p', { className: 'dsh-section-desc' }, t('sessionSettings.section.modelDesc'))), e('div', { className: 'dsh-sam-mode-list' }, sessionId
            ? e('label', {
    ...
    activeNav === 'mcp'
        ? e('div', { className: 'dsh-view-content-inner' }, 
        // Section Header: Title + Description
        e('div', { className: 'dsh-section-header' }, e('h3', { className: 'dsh-section-title' }, t('sessionSettings.section.mcpTitle')), e('p', { className: 'dsh-section-desc' }, t('sessionSettings.section.mcpDesc'))), sessionId
            ...
            : e('div', { className: 'dsh-session-mcp-box' }, mcpConfig.mode === 'custom' || !sessionId
                ...
                return e('div', {
                    ...
                    ? (() => {
                        const isCustomTools = mcpConfig.toolsMode?.[server.id] ===
                            'custom';
    ...
    activeNav === 'skills'
        ? e('div', { className: 'dsh-view-content-inner' }, 
        // Section Header: Title + Description
        e('div', { className: 'dsh-section-header' }, e('h3', { className: 'dsh-section-title' }, t('sessionSettings.section.skillsTitle')), e('p', { className: 'dsh-section-desc' }, t('sessionSettings.section.skillsDesc'))), sessionId
            ? e('div', { className: 'dsh-sam-mode-list' }, e('label', {
            ...
            (() => {
                ...
                return e('div', { className: 'dsh-session-skills-list' }, filteredSkills.map((skill) => {
                    ...
                    }, e('div', { className: 'dsh-session-skill-main' }, e('div', { className: 'dsh-session-skill-info' }, e('div', { className: 'dsh-session-skill-row1' }, e('div', {
                        className: 'dsh-session-skill-title-wrap',
                    }, e(IconSkillOutline16, { size: 14 }), e('span', { className: 'dsh-session-skill-name' }, skill.name), e('span', {
    ...
    e('div', { className: 'dsh-session-view-footer' }, e('div', { className: 'dsh-view-footer-left' }, sessionId && hasSessionOverride
        ? e('button', {
            type: 'button',
        ...
        : null), e('div', { className: 'dsh-view-footer-right' }, sessionId
        ? e('button', {
            type: 'button',
